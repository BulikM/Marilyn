            ...
            <div class="col-12 d-flex justify-content-lg-between justify-content-evenly">
                ...
                <ul class="list-unstyled d-flex justify-content-evenly">
                    @guest
                        @if (Route::has('login'))
                            <li class="navbarRightOptions px-3 py-2 headerListItemSeparator d-none d-lg-flex">
                                <a class="headerLink" href="#" data-bs-toggle="modal" data-bs-target="#loginmodal">Log In</a>
                            </li>
                        @endif
                    @else
                        <li class="navbarRightOptions px-3 py-2 headerListItemSeparator d-none d-lg-flex">
                    ...
                    <li class="ps-3 mt-2 navbarRightOptions d-none d-lg-flex">
                        <a href="https://shop.goop.com/account/wish_list" aria-label="wishlist heart" class="headerLink iconHeader">
                    ...
                    <li class="ps-lg-3 mt-2 navbarRightOptions">
                        <a aria-label="cart" class="headerLink iconHeader">
                            ...
                            <span class="totalbasket totalbasketText">0</span>
                        </a>
                    </li>
                </ul>
            </div>
