            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="ui-basic">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"><a class="nav-link" href={{route("users.index")}}>Users overview</a></li>
                        <li class="nav-item"><a class="nav-link" href={{route('users.create')}}>Create a user</a>
                        </li>
                    </ul>
                </div>
            </li>
