...
{{--voorkeuren--}}
                        ...
                        <div class="row row-cols-1 row-cols-lg-3">
                            @foreach($preferences as $preference)
                                <div class="card col bg-none" >
                                    <input type="checkbox" class="btn-check" value="{{$preference->id}}" name="preferences[]" id="preference{{$preference->id}}" autocomplete="off">
                                    <label class="btn btn-outline-purple" for="preference{{$preference->id}}">{{$preference->name}}</label><br>
                                </div>
                            @endforeach
                            </div>
                        ...
                        <div class="row row-cols-1 row-cols-lg-3">
                            @foreach($newsletterinfos as $info)
                                <div class="card col bg-none" >
                                    <input type="checkbox" class="btn-check" value="{{$info->id}}" name="newsletterinfos[]" id="info{{$info->id}}" autocomplete="off">
...
<div class="d-flex justify-content-center gap-3">
                        <button type="submit" class="button btn-gradient-purple">SUBMIT</button>
